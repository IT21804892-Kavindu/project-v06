...
RF_MODEL_PATH = MODEL_DIR / 'random_forest_regression_model.pkl'
TS_MODEL_PATH = MODEL_DIR / 'timeseries_model.keras'
...
def predict():
    ...
    try:
        ...
        # Validate input data
        required_fields = ['rainfall', 'temperature', 'waterContent']
